...
class TeamIdentityResolver:
    ...
    _ALIASES: ClassVar[dict[str, str]] = {
        ...
        "mjallbyaif": "mjallby",
        "萨尔茨堡": "rbsalzburg",
        "redbullsalzburg": "rbsalzburg",
        "rbsalzburg": "rbsalzburg",
        "阿拉木图凯拉特": "kairatalmaty",
        "阿拉木图": "kairatalmaty",
        "凯拉特": "kairatalmaty",
        "kairatalmaty": "kairatalmaty",
        "kairat": "kairatalmaty",
        "安德莱赫特": "anderlecht",
        "安德莱": "anderlecht",
        ...
        "fcthun": "thun",
        "thun": "thun",
        "贝尔格莱德红星": "redstarbelgrade",
        "贝红星": "redstarbelgrade",
        "redstarbelgrade": "redstarbelgrade",
        "fkcrvenazvezda": "redstarbelgrade",
        "crvenazvezda": "redstarbelgrade",
        "比尔森": "viktoriaplzen",
    ...
    _SUFFIXES: ClassVar[frozenset[str]] = frozenset({"cf", "fc", "fk", "ud", "club"})
